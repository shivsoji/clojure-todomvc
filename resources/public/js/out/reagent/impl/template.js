...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__27819__auto__,writer__27820__auto__,opt__27821__auto__){
return cljs.core._write.call(null,writer__27820__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__28877 = o;
(G__28877[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__28878__delegate = function (args){
...
while (G__28879__i < G__28879__a.length) {G__28879__a[G__28879__i] = arguments[G__28879__i + 0]; ++G__28879__i;}
  args = new cljs.core.IndexedSeq(G__28879__a,0);
} 
return G__28878__delegate.call(this,args);};
...
return G__28878__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__27196__auto__ = !((jsprops == null));
if(and__27196__auto__){
var and__27196__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__28886 = jsprops;
(G__28886["defaultValue"] = value);

(G__28886["onChange"] = ((function (G__28886,v,value,on_change){
return (function (p1__28883_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__28883_SHARP_);
});})(G__28886,v,value,on_change))
);

(G__28886["ref"] = ((function (G__28886,v,value,on_change){
return (function (p1__28884_SHARP_){
return (this$["cljsInputElement"] = p1__28884_SHARP_);
});})(G__28886,v,value,on_change))
);
...
var vec__28893 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__28893,(0),null);
var id = cljs.core.nth.call(null,vec__28893,(1),null);
var class$ = cljs.core.nth.call(null,vec__28893,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___28898 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___28898 == null)){
} else {
var key_28899 = temp__4661__auto___28898;
(jsprops["key"] = key_28899);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__28901 = (new reagent.impl.template.NativeWrapper());
(G__28901["name"] = c);
...
var len__28321__auto___28907 = arguments.length;
var i__28322__auto___28908 = (0);
while(true){
if((i__28322__auto___28908 < len__28321__auto___28907)){
args__28328__auto__.push((arguments[i__28322__auto___28908]));

var G__28909 = (i__28322__auto___28908 + (1));
i__28322__auto___28908 = G__28909;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28329__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28905){
var G__28906 = cljs.core.first.call(null,seq28905);
var seq28905__$1 = cljs.core.next.call(null,seq28905);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__28906,seq28905__$1);
});
...
break;
default:
var G__28913 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__28913;
continue;
...
var n__28131__auto___28916 = a.length;
var i_28917 = (0);
while(true){
if((i_28917 < n__28131__auto___28916)){
(a[i_28917] = reagent.impl.template.as_element.call(null,(a[i_28917])));
...
var a = cljs.core.into_array.call(null,s);
var n__28131__auto___28919 = a.length;
var i_28920 = (0);
while(true){
if((i_28920 < n__28131__auto___28919)){
var val_28921 = (a[i_28920]);
if((cljs.core.vector_QMARK_.call(null,val_28921)) && ((reagent.impl.template.key_from_vec.call(null,val_28921) == null))){
(o["no-key"] = true);
} else {
}

(a[i_28920] = reagent.impl.template.as_element.call(null,val_28921));
...
var ctx = ({});
var vec__28926 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__28926,(0),null);
var derefed = cljs.core.nth.call(null,vec__28926,(1),null);
...
var G__28930 = (cljs.core.count.call(null,argv) - first_child);
switch (G__28930) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__28930){
...
//# sourceMappingURL=template.js.map?rel=1502515424356