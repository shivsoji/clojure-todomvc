...
var or__27208__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj34778 = {"detail":data};
return obj34778;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__27196__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__27196__auto__)){
var and__27196__auto____$1 = goog.object.get(window,"CustomEvent");
...
var args34783 = [];
var len__28321__auto___34789 = arguments.length;
var i__28322__auto___34790 = (0);
while(true){
if((i__28322__auto___34790 < len__28321__auto___34789)){
args34783.push((arguments[i__28322__auto___34790]));

var G__34791 = (i__28322__auto___34790 + (1));
i__28322__auto___34790 = G__34791;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args34783.length)].join('')));
...
var f = (function (){var pred__34786 = cljs.core._EQ_;
var expr__34787 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34786.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34787))){
return ((function (pred__34786,expr__34787){
return (function (p1__34779_SHARP_){
return console.warn(p1__34779_SHARP_);
});
;})(pred__34786,expr__34787))
} else {
if(cljs.core.truth_(pred__34786.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34787))){
return ((function (pred__34786,expr__34787){
return (function (p1__34780_SHARP_){
return console.debug(p1__34780_SHARP_);
});
;})(pred__34786,expr__34787))
} else {
if(cljs.core.truth_(pred__34786.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34787))){
return ((function (pred__34786,expr__34787){
return (function (p1__34781_SHARP_){
return console.error(p1__34781_SHARP_);
});
;})(pred__34786,expr__34787))
} else {
return ((function (pred__34786,expr__34787){
return (function (p1__34782_SHARP_){
return console.log(p1__34782_SHARP_);
});
;})(pred__34786,expr__34787))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34793){
var map__34796 = p__34793;
var map__34796__$1 = ((((!((map__34796 == null)))?((((map__34796.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__34796.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34796):map__34796);
var opts = map__34796__$1;
var eval_fn = cljs.core.get.call(null,map__34796__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34798_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__34800,(0),null);
var v = cljs.core.nth.call(null,vec__34800,(1),null);
...
var args34803 = [];
var len__28321__auto___34807 = arguments.length;
var i__28322__auto___34808 = (0);
while(true){
if((i__28322__auto___34808 < len__28321__auto___34807)){
args34803.push((arguments[i__28322__auto___34808]));

var G__34809 = (i__28322__auto___34808 + (1));
i__28322__auto___34808 = G__34809;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args34803.length)].join('')));
...
if(cljs.core.truth_((function (){var and__27196__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1502515430088